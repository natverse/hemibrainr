...
if(!exists("all.neurons.fafb")){
  all.neurons.fafb = xform_brain(all.neurons.flow.microns, reference = "FAFB14", sample = "JRCFIB2018F", .parallel = TRUE, verbose = TRUE, OmitFailures = TRUE, method = "rjava", progress.rjava=TRUE)
}
...
all.neurons.jrc2018f.m = xform_brain(all.neurons.jfrc2.m, reference = "JRC2018F", sample = "JFRC2", .parallel = TRUE, verbose = TRUE, OmitFailures = TRUE)
...
# Hemibrain, microns
all.neurons.flow.microns.m = xform_brain(all.neurons.jfrc2.m, reference = "JRCFIB2018F", sample = "JFRC2", .parallel = TRUE, verbose = TRUE, OmitFailures = TRUE)
all.neurons.flow.microns.m.dps = nat::dotprops(all.neurons.flow.microns.m, Labels = TRUE, resample = 1, OmitFailures = TRUE, .parallel = TRUE)
...
all.neurons.flow.microns.m.dps = as.neuronlistfh(all.neurons.flow.microns.m.dps, dbdir= "/net/flystore3/jdata/jdata5/JPeople/Alex/FIBSEM/data/neurons/fibsem/JRCFIB2018F/data/", WriteObjects = "yes")
write.neuronlistfh(all.neurons.flow.microns.m.dps, file="/net/flystore3/jdata/jdata5/JPeople/Alex/FIBSEM/data/neurons/fibsem/JRCFIB2018F/hemibrain_all_neurons_flow_JRCFIB2018F_dotprops_mirrored.rds", overwrite=TRUE)
...
write.neuronlistfh(all.neurons.flow.microns.m, file="/net/flystore3/jdata/jdata5/JPeople/Alex/FIBSEM/data/neurons/fibsem/JRCFIB2018F/hemibrain_all_neurons_flow_JRCFIB2018F_mirrored.rds", overwrite=TRUE)
...
write.neuronlistfh(all.neurons.flow.m, file="/net/flystore3/jdata/jdata5/JPeople/Alex/FIBSEM/data/neurons/fibsem/JRC2018raw/hemibrain_all_neurons_flow_JRC2018raw_mirrored.rds", overwrite=TRUE)

# Remove old filehash files
brains = c("JRC2018F","FCWB","JFRC2","JRCFIB2018F","FAFB14","FlyWire","JRCFIB2018Fraw")
