...
fafb_hemilineage_contents <- function(hemilineage,
  ...
  hl = elmr::read.neurons.fafb(sprintf("annotation:%s_Hemilineage: %s",nomenclature,hemilineage), ...)
  putative = catmaid::catmaid_skids(sprintf("annotation:%s_Hemilineage: %s_putative",nomenclature,hemilineage),...)
  hl[,]$confirmed = !hl[,]$skid %in% putative
