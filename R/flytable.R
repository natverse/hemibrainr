...
flytable_meta <- function(){
  ft=fafbseg::flytable_query("select _id, root_id, supervoxel_id, proofread, status, pos_x, pos_y, pos_z, nucleus_id, side, ito_lee_hemilineage, hartenstein_hemilineage, top_nt, flow, super_class, cell_class, cell_type, root_duplicated from info")
