...
Whilst configuring, you will be asked to supply some google credentials - you can proceed without doing this. However, I highly recommend obtaining your own google client id and client secret from the [developer console](https://console.developers.google.com/apis/) associated with your prefered google account. To do this, [follow these detailed instructions]( https://rclone.org/drive/#making-your-own-client-id). This allows you to operate with a higher API rate limit - if you proceed without you will be using the rclone credentials, which many users as operating with, and this might be slower.
