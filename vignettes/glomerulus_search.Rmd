...
dm6.upn.ids.biggest = fafb14_to_flywire_ids("name:Uniglomerular mALT DM6 adPN",
                                        only.biggest = TRUE)
dm6.upn.ids = dm6.upn.ids.biggest$flywire_id
...
### Or cheat and just get the skeletons from the drive:  dm6.upn.skels = subset(flywire_neurons(), flywire_id %in% dm6.upn.ids)
